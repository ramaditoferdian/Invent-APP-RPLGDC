...
import 'detailBarangUser.dart';

class HalamanUtamaUser extends StatefulWidget {
  const HalamanUtamaUser({Key? key}) : super(key: key);

  @override
  _HalamanUtamaUserState createState() => _HalamanUtamaUserState();
}
  ...
  Widget menuCard_dataBarang(String nama, kategori, banyak, image) {
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => DetailBarangUser()),
        );
      },
      child: Container(
