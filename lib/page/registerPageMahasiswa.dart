...
class RegisterPageMahasiswa extends StatefulWidget {
  const RegisterPageMahasiswa({Key? key}) : super(key: key);

  @override
  _RegisterPageMahasiswaState createState() => _RegisterPageMahasiswaState();
}

class _RegisterPageMahasiswaState extends State<RegisterPageMahasiswa> {
  // Kumpulan widget
  ...
  Widget buildContainer() {
    return Column(
      ...
      children: <Widget>[
        ...
        // KOTAK PEMBUNGKUS NAMA, EMAIL, NIM, FAKULTAS, PASSWORD
        ClipRRect(
