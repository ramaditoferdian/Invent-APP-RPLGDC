...
class HalamanUtamaGuest extends StatefulWidget {
  const HalamanUtamaGuest({Key? key}) : super(key: key);

  @override
  _HalamanUtamaGuestState createState() => _HalamanUtamaGuestState();
}
...
class _HalamanUtamaGuestState extends State<HalamanUtamaGuest> {
...
// MENU CARD
  ...
  Widget menuCard_prosesBarang(String nama, status, peminjam, image) {
    return GestureDetector(
      onTap: () {
...
class Pending {
  late String name, status, borrower, image;
